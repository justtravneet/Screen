    ...
    <div  className='px-[16px] lg:px-[48px] xl:px-[200px] py-4'>
        ...
        <div className='flex flex-col gap-10 lg:flex-row lg:justify-between  lg:gap-20 mt-10'>
               <div className=' flex flex-col gap-3 border-black border-2'>
                <img className=' lg:w-auto xl:w-[450px]' src="https://s3-alpha-sig.figma.com/img/7689/18d8/5b3715bbc1111e43e99337b50fec566b?Expires=1715558400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=azsz~JlU7vabz8P5UHayKIV5hIR173i-sebMjoGdJtdaLGYDH8zcN2ws56gNfEdJqUylnWVICyFSLthlOV-T4tlhqSJ2l9XDqpY037uNEx8HUswUPhqLbnC5sGHYY9wMjYh1Nrko~wJximzOkg3UXW957z82YCCTibFQuRFUEnik3jwoPNKssFpS3u5qMlC6bQ~~hgsmppX11fvYQzrL7WdJdqscsSbpmwXwVdQ7A2nIBgKRoLWqOBVYZhlcWAPByuHTiiXiMCDVAwVPO-EBMzz1OxL4n7-XdwpBblKElyTyHvTGQZ9ecwFycdee~smn9WU-7Y98dbTe5jSE~hkejQ__" alt="" />
                <div className='mt-1 grid gap-2'>
                    <p className=' pl-1 font-semibold text-xs lg:text-sm'>ALL</p>
                     <h2 className='pl-1 text-lg font-bold lg:text-2xl'>Master the Art of Web Design</h2>
                     <p className='pl-2 text-xs  lg:text-lg xl:'>Learn the latest techniques and trends in web design</p>
                </div>
               ...
               <div className=' flex flex-col gap-3 border-black border-2'>
                <img className=' lg:w-auto xl:w-[450px]' src="https://s3-alpha-sig.figma.com/img/6772/cd9c/2db2270153b04b030eb43eda6e0f0b5b?Expires=1715558400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=gTrp5arxSQnKfgcewBloNHdg2kiMj5UBNzOFj1DM3-IahY-hehvTTEAO1Suq9B23FJFx~MaXNIyACsDGEk0ej0C7FMfJcq9kT982CyZXbEmTlrmGtL-NH8DGUzRrV5lWhzzNvMauOtNcqvbehCiN4WSn-tjcxfAjx3~AVcKDmzQd6I1vj4TsFKFokqEkUoTZmWBPwW3ZyN5-aKms2pRxOlSixYh7wbu3kU~sBLlyV5tB4AStx4A28j51mlNyyNjHw0g8cySzfzw4-tXjk8GhF7lSuNAA0nKZc23p7nHo7agbPIBO~5OUvi1Gufqmm8gBmoodU~ucBt7NLgu1sznKvA__" alt="" />
               
                <div className='mt-1 grid gap-2'>
                    <p className=' pl-1 font-semibold text-xs lg:text-sm'>ALL</p>
                     <h2 className='pl-1 text-lg font-bold lg:text-2xl'>Master the Art of Web Development</h2>
                     <p className='pl-2 text-xs  lg:text-lg xl:'>Learn the skills to build powerful and dynamic websites.</p>
                </div>
