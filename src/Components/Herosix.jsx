    ...
    <div  className='conatiner  p-3   lg:p-10 bg-white mt-5  '>
        ...
        <div className='flex flex-col gap-10 lg:flex-row lg:justify-between lg:gap-20 mt-10'>
               <div className=' flex flex-col gap-3 border-black border-2'>
                ...
                <p className='pl-2 text-xs  lg:text-lg'>Learn the latest techniques and trends in web design</p>
               ...
               <div className=' flex flex-col gap-3 border-black border-2'>
                ...
                <p className=' pl-1 font-semibold text-xs lg:text-sm'>ALL</p>
                <h2 className='pl-1 text-lg font-bold lg:text-xl'>Master the Art of Web Development</h2>
                <p className='pl-1 text-xs lg:text-lg'>Learn the skills to build powerful and dynamic websites.</p>
