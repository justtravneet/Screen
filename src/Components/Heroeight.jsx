...
const Heroeight = () => {
  return (
    <div className='px-[16px] lg:px-[48px] xl:px-[200px] bg-white flex flex-col'>
           ...
           <div className='flex  justify-center  lg:justify-between gap-2 flex-wrap  '>
                 <div className='flex flex-col gap-3 w-96 lg:justify-around   lg:w-72 border-black border-2'>
                       <img width={120} className='pl-2 pt-2' src="https://www.pngplay.com/wp-content/uploads/6/5-Star-Rating-Review-Transparent-PNG.png" alt="" />
